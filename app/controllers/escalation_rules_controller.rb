class EscalationRulesController < ApplicationController
  ...
  def escalation_rule_params
    params.require(:escalation_rule).permit(:name, :airplane_mode_on, :weekend_airplane_mode_on, :weekday_airplane_mode_on, :weekend_airplane_mode_start_time, :weekend_airplane_mode_end_time, :weekday_airplane_mode_start_time, :weekday_airplane_mode_end_time, :voice_message)
  end
end
